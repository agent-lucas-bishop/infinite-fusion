...
// === EXTRA RECIPES ===
r('mud','stone','clay');
r('clay','water','pottery');
r('sand','stone','mountain');
r('ice','ice','glacier');
r('ocean','wind','wave');
r('cloud','cold','snow');
r('rain','wind','hurricane');
r('dust','wind','storm');
r('lava','lava','volcano');
r('ash','water','mud');
r('ash','earth','fossil');
r('obsidian','fire','glass');
r('metal','stone','ore');
r('steel','wood','sword');
r('gold','stone','gem');
r('silver','stone','gem');
r('copper','fire','bronze');
r('iron','coal','steel');
r('brick','fire','ceramic');
r('concrete','water','cement');
r('paper','ink','story');
r('wood','wood','forest');
r('charcoal','fire','heat');
r('rope','metal','chain');
r('plant','plant','forest');
r('tree','tree','forest');
r('flower','flower','meadow');
r('grass','water','plant');
r('seed','fire','ash');
r('mushroom','fire','poison');
r('algae','fire','ash');
r('cactus','fire','ash');
r('fish','fish','school');
r('bird','bird','flock');
r('insect','insect','swarm');
r('bee','bee','hive');
r('ant','ant','colony');
r('human','stone','tool');
r('human','plant','farm');
r('human','wheat','flour');
r('human','knowledge','science');
r('human','music','art');
r('human','love','life_force');
r('dragon','fire','explosion');
r('dragon','dragon','hydra');
r('phoenix','phoenix','sun');
r('zombie','zombie','horde');
r('wizard','wizard','academy');
r('electricity','electricity','lightning');
r('light','light','laser');
r('sound','sound','thunder');
r('wave','wave','tsunami');
r('solar','earth','plant');
r('nuclear','fire','explosion');
r('circuit','light','bulb');
r('computer','internet','ai');
r('rocket','star','space_station');
r('car','car','traffic');
r('ship','wind','sail');
r('bread','bread','sandwich');
r('sugar','fire','candy');
r('milk','fire','cheese');
r('fruit','fire','jam');
r('coffee','coffee','energy');
r('time','life_force','death');
r('love','love','passion');
r('knowledge','knowledge','wisdom');
r('chaos','chaos','void');
r('order','order','civilization');

e('ore',      'Ore',       '⛏️', 'material');
e('chain',    'Chain',     '⛓️', 'material');
e('school',   'School',    '🐟', 'life');
e('flock',    'Flock',     '🐦', 'life');
e('swarm',    'Swarm',     '🐝', 'life');
e('hive',     'Hive',      '🐝', 'life');
e('colony',   'Colony',    '🐜', 'life');
e('horde',    'Horde',     '🧟', 'mythical');
e('academy',  'Academy',   '🏫', 'concept');
e('traffic',  'Traffic',   '🚗', 'concept');
